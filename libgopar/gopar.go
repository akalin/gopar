...
func Par(args_ []string, islib bool) int {
	...
	if islib == false && globalFlags.cpuProfile != "" {
...
func Gopar(args_ []string) int {
	args_ = append([]string{"libgopar"}, args_...)
	return (Par(args_,true))
}
